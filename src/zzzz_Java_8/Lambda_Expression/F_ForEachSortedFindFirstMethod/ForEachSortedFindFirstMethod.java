...
public class ForEachSortedFindFirstMethod {
	...
	public static void main(String[] args) {
		...
		System.out.println("Product List - sorted - Ascending Order (a...z) and findFirst records");
		...
		System.out.println("\nProduct List - sorted - Descending Order (z...a) and findFirst records");
		...
		System.out.println("\nProduct List - filter and findFirst records");
